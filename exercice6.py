...
def effectuerRotation(nombreComplexe, angle_rotation, trouverModule):
    ...
    print("le module est égale à ", round(module,3), "l'angle est ", round(angle,3))


    # TODO: Calculer le nouveau nombre complexe après rotation, assigner le nouveau nombre complexe à la variable 'resultat'
    x=complex(math.cos(angle),math.sin(angle))


    resultat = nombreComplexe*x
    ...
    print("le nouveau module est égale à ", round(nouveauModule, 3), "le nouvel angle est ", round(nouvelAngle, 3))
